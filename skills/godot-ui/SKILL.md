...
> **Related skills:** **input-handling** for UI focus navigation and action mapping, **event-bus** for decoupling UI from game state, **scene-organization** for structuring UI scenes.
