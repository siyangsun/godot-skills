...
> **Related skills:** **godot-ui** for UI input focus and navigation, **save-load** for persisting custom key bindings, **state-machine** for input-driven state transitions.
