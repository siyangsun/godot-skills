...
> **Related skills:** **component-system** for direct signal communication between components, **dependency-injection** for alternative decoupling approaches, **scene-organization** for deciding what belongs on the bus.
