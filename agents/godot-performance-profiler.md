...
- **Subsystem skills:** Read whichever applies given the bottleneck:
  ...
  - Rendering / draw calls (2D) → `skills/2d-essentials/SKILL.md`
  - Rendering / LOD / culling (3D) → `skills/3d-essentials/SKILL.md`
...
- **Do not rewrite shaders for perf.** Flag the shader as the suspected cost and stop there.
