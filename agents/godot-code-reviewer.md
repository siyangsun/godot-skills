...
description: |
  ...
  Examples:
  <example>Context: User wants a code review. user: "Review my movement code for Godot best practices" assistant: "I'll use the godot-code-reviewer agent to review the code." <commentary>Code review request — use the reviewer agent to check against skill patterns.</commentary></example>
  <example>Context: User finished implementing a feature. user: "I just finished the save system, can you check it?" assistant: "Let me use the godot-code-reviewer agent to review the implementation." <commentary>Feature completion review — use the reviewer to check against skill patterns.</commentary></example>
model: inherit
---
...
**Step 1: Work through the review checklist**

Review every file against these sections:
...
- Animation? Read `skills/animation-system/SKILL.md`
- Audio? Read `skills/audio-system/SKILL.md`
- Cameras? Read `skills/camera-system/SKILL.md`
- Components / composition? Read `skills/component-system/SKILL.md`
- Resources / data containers? Read `skills/resource-pattern/SKILL.md`
- Dependency wiring? Read `skills/dependency-injection/SKILL.md`
- UI? Read `skills/godot-ui/SKILL.md`
- Signals? Read `skills/event-bus/SKILL.md`
- Scene structure? Read `skills/scene-organization/SKILL.md`
...
- Tests? Read `skills/godot-testing/SKILL.md`

**Step 3: Review the code**

Read all files being reviewed. Compare against skill patterns. Check the checklist point by point.
...
- Work the checklist in Step 1 top to bottom — not ad-hoc review
